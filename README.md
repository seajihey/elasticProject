...
- 발견  
  데이터 분석 결과, **디지털 채널(모바일 앱) 가입 고객의 월 평균 총 이용 금액이 비가입 고객 대비 월등히 높게 나타났다.** 특히 디지털 채널 가입 고객 중에서도 **라이프스타일이 외식·여가·온라인 소비 중심인 고객군**은 타 고객군 대비 카드 사용 빈도와 이용 금액 모두 높은 수준을 보였다.
- 활용  
  디지털 채널 미가입 고객을 대상으로 **앱 가입 유도 캠페인**을 강화할 필요가 있으며, 그중에서도 외식·여가·온라인 쇼핑 소비 성향을 가진 고객을 핵심 타겟으로 설정할 경우 마케팅 효율을 극대화할 수 있다. 앱 가입 시 개인 소비 패턴에 기반한 혜택 추천과 실시간 이용 내역 시각화를 제공한다면, 디지털 채널 활성화와 동시에 카드 이용 금액 증대라는 이중 효과를 기대할 수 있다.

### 가설 3
<br>
<img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/ecd584b0-ed5f-442b-b1b6-7e86971c6726" />
<img width="500" height="500" alt="image" src="https://github.com/user-attachments/assets/8d93a37e-f04f-4105-a364-9cd24785f3f5" />
<img width="500" height="500" alt="image" src="https://github.com/user-attachments/assets/115a2b10-7684-4931-9f29-4348aa3d4564" />
...
#### [인사이트 3] 결제 수단 전환의 심리적 허들 제거
- 발견  
  하위 등급 고객은 연회비나 과소비에 대한 우려로 체크카드를 선호하는 경향이 있다.
- 활용  
